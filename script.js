...
const data = {
    ...
    packaging: {
        ...
        'Термо 250мм/650мп': 6,
        'Термо 400мм/650мп': 8,
        'Термо 450мм/650мп': 10,
        'Запайка 200мм/330мп': 9,
        'Запайка 300мм/330мп': 10,
        'Запайка 500мм/250мп': 17,
        'Запайка 100мм/650мп': 5,
        'ВПП 15см/1м': 5,
        'ВПП 35см/1м': 12,
        'ВПП 75см/1м': 22,
...
async function calculate() {
    ...
    try {
        ...
        for (let i = 0; i < 2; i++) {
            ...
            // ИСПРАВЛЕНО: Используем фиксированные цены из data.marking
            const pricePerItem = data.marking[type] || 0;
            
            if (type && qty > 0 && pricePerItem > 0) {
